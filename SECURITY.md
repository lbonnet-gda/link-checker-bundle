...
This bundle crawls and requests URLs discovered on third-party pages; SSRF, request-forgery, and denial-of-service
concerns around that behavior are explicitly in scope, including in its underlying dependencies.
